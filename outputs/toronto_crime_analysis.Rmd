...
To better understand how population varies, I reported the min, the max, the mean, and the standard deviation of all neighbourhoods in the Greater Toronto Area using `kableExtra` [@kableExtra] (Table \@ref(tab:pop)). The Population Max confirms that Waterfront Communities-The Island has one of the largest population sizes and that Bay Street Corridor has an average population size. Kensington-Chinatown similarly has an average population size compared to the Population Mean and Population Min despite it being on the bottom end of the gradient scale in Figure \@ref(fig:popcrime).
...
Moss Park is a small neighbourhood that only spans two blocks between Jarvis Street and Parliament Street. It is well known for being the site of CBC's Kim's Convenience TV Show but as well as for being dominated by public housing projects. Moss Park has 34.6% of its residents living in poverty and 31.9% classified as low income. Additionally, 39.9% of households live in unaffordable housing. The visible minority population makes up 42.6% of Moss Park and 2.1% of residents identify as Aboriginal.
